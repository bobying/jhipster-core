...
// added end by yingmingbo
  MAXBYTES, MAXLENGTH, MIN, MINBYTES, MINLENGTH, PATTERN } = require('./validations');
...
// modified begin by yingmingbo
  String: new Set([REQUIRED, UNIQUE, MINLENGTH, MAXLENGTH, PATTERN, READONLY, AUTOCREATE, AUTOUPDATE]),
...
// modified begin by yingmingbo
  LocalDate: new Set([REQUIRED, UNIQUE, READONLY, AUTOCREATE, AUTOUPDATE]),
  ZonedDateTime: new Set([REQUIRED, UNIQUE, READONLY, AUTOCREATE, AUTOUPDATE]),
// modified end by yingmingbo
...
// modified begin by yingmingbo
  Instant: new Set([REQUIRED, UNIQUE, READONLY, AUTOCREATE, AUTOUPDATE]),
// modified end by yingmingbo
...
const CassandraValidations = {
  ...
  UUID: new Set([REQUIRED, UNIQUE]),
// modified begin by yingmingbo
  Instant: new Set([REQUIRED, UNIQUE, READONLY]),
// modified end by yingmingbo
  ByteBuffer: new Set([REQUIRED, UNIQUE, MINBYTES, MAXBYTES]),
// modified begin by yingmingbo
  ZonedDateTime: new Set([REQUIRED, UNIQUE, READONLY])
// modified end by yingmingbo
};
