...
// added begin by yingmingbo
  const addDataset = dataset => merged.addDataset(dataset);
  const addPage = page => merged.addPage(page);
  const addJsonConfig = jsonConfig => merged.addJsonConfig(jsonConfig);
...
// added begin by yingmingbo
  firstJDLObject.forEachDataset(addDataset);
  secondJDLObject.forEachDataset(addDataset);
  firstJDLObject.forEachPage(addPage);
  secondJDLObject.forEachPage(addPage);
  firstJDLObject.forEachJsonConfig(addJsonConfig);
  secondJDLObject.forEachJsonConfig(addJsonConfig);
// added end by yingmingbo
