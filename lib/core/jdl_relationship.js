...
// added begin by yingmingbo
    this.optionsOfFrom = merged.optionsOfFrom;
    this.optionsOfTo = merged.optionsOfTo;
    this.optionsOfInjectedFieldInFrom = merged.optionsOfInjectedFieldInFrom;
    this.optionsOfInjectedFieldInTo = merged.optionsOfInjectedFieldInTo;
    this.isInjectedFieldInFromReadonly = merged.isInjectedFieldInFromReadonly;
// added end by yingmingbo
    this.isInjectedFieldInToRequired = merged.isInjectedFieldInToRequired;
// added begin by yingmingbo
    this.isInjectedFieldInToReadonly = merged.isInjectedFieldInToReadonly;
// added end by yingmingbo
...
// added begin by yingmingbo
      string += `{${this.injectedFieldInFrom}${this.isInjectedFieldInFromReadonly ? ' readonly(' + this.isInjectedFieldInFromReadonly + ')' : ''}}`;
// added end by yingmingbo
    }
    string += ' to';
    if (this.commentInTo) {
...
// added begin by yingmingbo
    isInjectedFieldInFromReadonly: false,
// added end by yingmingbo
    isInjectedFieldInToRequired: false,
// added begin by yingmingbo
    isInjectedFieldInToReadonly: false,
// added end by yingmingbo
    options: {},
    commentInFrom: '',
    commentInTo: ''
