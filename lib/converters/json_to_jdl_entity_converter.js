...
// modified begin by yingmingbo
    injectedFieldInSourceIsRequired: relationship.relationshipValidateRules.includes('required'),
    injectedFieldInSourceIsReadonly: relationship.relationshipValidateRules.includes('readonly'),
...
// modified begin by yingmingbo
  if (!!foundDestinationSideEntity.otherEntityField && foundDestinationSideEntity.otherEntityField[0] !== 'id') {
// modified end by yingmingbo
    injectedFieldInDestinationEntity += `(${foundDestinationSideEntity.otherEntityField})`;
  }
// modified begin by yingmingbo
  const injectedFieldInDestinationIsRequired = !!foundDestinationSideEntity.relationshipValidateRules.includes('required');
// modified end by yingmingbo
...
// added begin by yingmingbo
    isInjectedFieldInFromReadonly: relationshipConfiguration.injectedFieldInSourceIsReadonly,
// added end by yingmingbo
    isInjectedFieldInToRequired: relationshipConfiguration.injectedFieldInDestinationIsRequired,
// added begin by yingmingbo
    isInjectedFieldInToReadonly: relationshipConfiguration.injectedFieldInDestinationIsReadonly,
// added end by yingmingbo
...
// modified begin by yingmingbo
    (relationship.otherEntityField && relationship.otherEntityField[0] !== 'id'
// modified end by yingmingbo
...
function addEntityOptionsToJDL(entity, entityName) {
  ...
  if (entity.virtual === true) {
    addUnaryOptionToJDL(VIRTUAL, entityName);
  }
