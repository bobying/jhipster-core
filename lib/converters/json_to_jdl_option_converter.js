...
const { WEB_SERVICE, SKIP_CLIENT, SKIP_SERVER, SKIP_USER_MANAGEMENT } = require('../core/jhipster/unary_options');
...
function convertServerOptionsToJDL(config, jdl) {
  ...
  [WEB_SERVICE, SKIP_CLIENT, SKIP_SERVER, SKIP_USER_MANAGEMENT].forEach(option => {
