...
class RelationshipValidator extends Validator {
  constructor(skippedUserManagementOption) {
    super('relationship', ['from', 'to', 'type']);
    this.skippedUserManagementOption = skippedUserManagementOption;
  }

  validate(jdlRelationship, skippedUserManagementOption) {
    super.validate(jdlRelationship);
    skippedUserManagementOption = skippedUserManagementOption || this.skippedUserManagementOption;
