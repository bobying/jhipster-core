...
// added by yingmingbo begin
const ALPHANUMERIC_DOT = /^[A-Za-z][A-Za-z0-9\.]*$/;
// added by yingmingbo end
...
// modified begin by yingmingbo
      if (context.injectedFieldParams) {
        this.checkNameSyntax(context.injectedFieldParams[0], ALPHANUMERIC_DOT, 'injectedField');
