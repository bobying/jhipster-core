...
createTokenFromConfig({ name: 'JSONCONFIG', pattern: 'json' });

// for page
createTokenFromConfig({ name: 'PAGE', pattern: 'page' });
...
createTokenFromConfig({ name: 'REF', pattern: 'ref' });

// 新增文件
createTokenFromConfig({ name: 'FILES', pattern: 'files' });
...
*/
createTokenFromConfig({ name: 'DATASET', pattern: 'dataset' });
/*
createTokenFromConfig({
  name: 'DATASET_BODY',
