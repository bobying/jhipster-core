...
const { checkDatasets } = require('./dataset_linter');
...
function checkForDatasetIssues() {
  const datasetDeclarations = cst.children.datasetDeclaration;
  const datasetIssues = checkDatasets(datasetDeclarations);
  issues.addDatasetIssues(datasetIssues);
}
// added end by yingmingbo
