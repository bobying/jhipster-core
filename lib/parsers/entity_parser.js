...
function setOptionsForRelationship(relatedRelationship, relationship) {
  ...
  if (relationship.ownerSide !== true) {
    if (relationship.options === undefined || relationship.options === null ) {
      relationship.options = {};
    }
    if (relatedRelationship.optionsOfTo && relatedRelationship.optionsOfTo['translate']) {
      relationship.options['translate'] = relatedRelationship.optionsOfTo['translate'];
    } else {
      relationship.options['translate'] = null;
    }
  }
}
